...
```
testCompile("lv.ctco.cukes:cukes-core:1.0.10");
```
...
```
testCompile("lv.ctco.cukes:cukes-http:1.0.10");
```
...
```
testCompile("lv.ctco.cukes:cukes-graphql:1.0.10");
```
...
```
testCompile("lv.ctco.cukes:cukes-ldap:1.0.10");
```
...
```
testCompile("lv.ctco.cukes:cukes-rabbitmq:1.0.10");
```
...
```
testCompile("lv.ctco.cukes:cukes-rest:1.0.10");
```
...
|request body is a multipart file from path "(.+)"||
...
```
testCompile("lv.ctco.cukes:cukes-http-mock:1.0.10");
```
