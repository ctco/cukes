...
```
testCompile("lv.ctco.cukes:cukes-core:0.0.31");
```
...
```
testCompile("lv.ctco.cukes:cukes-http:0.0.31");
```
...
```
testCompile("lv.ctco.cukes:cukes-graphql:0.0.31");
```
...
```
testCompile("lv.ctco.cukes:cukes-ldap:0.0.31");
```
...
```
testCompile("lv.ctco.cukes:cukes-rabbitmq:0.0.31");
```
...
```
testCompile("lv.ctco.cukes:cukes-rest:0.0.31");
```
...
```
testCompile("lv.ctco.cukes:cukes-http-mock:0.0.31");
```
